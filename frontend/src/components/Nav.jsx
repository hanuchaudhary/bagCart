...
const Nav = () => {
  ...
  return (
    <div className="sticky overflow-hidden  mt-2 z-10 opacity-85 bg-black px-5 rounded-full top-0 right-0 left-0 py-4 w-[80%] transition-transform m-auto text-white flex items-center justify-between ">
      <Link
        to={"/"}
